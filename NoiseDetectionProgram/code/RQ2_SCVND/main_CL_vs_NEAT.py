...
#                 list_mislabels_RF = [errors_idx_all,errors_idx_1,errors_idx_0];
                ...
                errors_idx_all,array_lateralMargin = Class_CL.FUNCTION_confidentLearning_fromPredictionProbability(array_psx_allClassifiers, original_labels);
